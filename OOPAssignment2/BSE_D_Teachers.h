...
namespace OOPAssignment2 {
    ...
    public ref class BSE_D_Teachers : public System::Windows::Forms::Form
    {
    public:

        BSE_D_Teachers(String^ sectionName, String^ filePath)
        {
            InitializeComponent();
            LoadTeachers(); // Load teachers from file
            // You can use sectionName and filePath as needed
        }
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->button1->Click += gcnew System::EventHandler(this, &BSE_D_Teachers::button1_Click);
            // 
            // BSE_D_Teachers
            // 
            ...
            this->Name = L"BSE_D_Teachers";
            this->Text = L"BSE_D_Teachers";
            this->Load += gcnew System::EventHandler(this, &BSE_D_Teachers::BSE_D_Teachers_Load);
            this->ResumeLayout(false);

        }

        void BSE_D_Teachers_Load(System::Object^ sender, System::EventArgs^ e)
        {
        ...
        void LoadTeachers()
        {
            String^ filePath = "BSE-D_teachers.txt"; // Path to the teachers file
            try
            {
        ...
        void button1_Click(System::Object^ sender, System::EventArgs^ e)
        {
            ...
            {
                String^ sectionName = "BSE-D"; // Assuming BSE-D section for demonstration
                String^ teacherFilePath = "BSE-D_timetable.txt";
