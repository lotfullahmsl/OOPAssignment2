...
namespace OOPAssignment2 {
    ...
    public ref class BSE_A_Teachers : public System::Windows::Forms::Form
    {
    public:
        BSE_A_Teachers(String^ sectionName, String^ filePath)
        {
            InitializeComponent();
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->comboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &BSE_A_Teachers::comboBox1_SelectedIndexChanged);
            // 
            // button1
            // 
            ...
            this->button1->Click += gcnew System::EventHandler(this, &BSE_A_Teachers::button1_Click);
            // 
            // BSE_A_Teachers
            // 
            ...
            this->Name = L"BSE_A_Teachers";
            this->Text = L"BSE_A_Teachers";
            this->Load += gcnew System::EventHandler(this, &BSE_A_Teachers::BSE_A_Teachers_Load);
            this->ResumeLayout(false);

        }

        void BSE_A_Teachers_Load(System::Object^ sender, System::EventArgs^ e)
        {
        ...
        void LoadTeachers()
        {
            String^ filePath = "BSE-A_teachers.txt"; // Path to the teachers file
            try
            {
        ...
        void button1_Click(System::Object^ sender, System::EventArgs^ e)
        {
            ...
            {
                String^ sectionName = "BSE-A"; // Assuming BSE-A section for demonstration
                String^ teacherFilePath = "BSE-A_timetable.txt";
