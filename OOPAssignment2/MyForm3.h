#include <msclr\marshal_cppstd.h> // Add this header for string marshalling
#include "MyForm2.h" // Include the login form header file
#include <fstream>
#include  "MyForm4.h"
#pragma once
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            // textBox1
            // 
            this->textBox1->Location = System::Drawing::Point(111, 95);
            ...
            // textBox2
            // 
            this->textBox2->Location = System::Drawing::Point(111, 121);
            ...
            this->button1->Location = System::Drawing::Point(164, 165);
            ...
            this->label3->Location = System::Drawing::Point(107, 37);
            this->label3->Name = L"label3";
            this->label3->Size = System::Drawing::Size(191, 19);
            this->label3->TabIndex = 6;
            this->label3->Text = L"- Please Sign up Here -";
            // 
            // label1
            // 
            ...
            this->label2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
                static_cast<System::Byte>(0)));
            this->label2->Location = System::Drawing::Point(24, 121);
...
#pragma endregion
    ...
    private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
        // check if bote box are not empty
        if (textBox1->Text == "") {
        ...
        if (outFile.is_open()) {
            ...
            outFile << nameStr << "," << passwordStr << std::endl;
            ...
            // Show error message if the file cannot be opened
            MessageBox::Show("Error: Unable to open file for writing.");
        }
    }
