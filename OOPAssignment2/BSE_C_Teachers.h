...
namespace OOPAssignment2 {
    ...
    public ref class BSE_C_Teachers : public System::Windows::Forms::Form
    {
    public:
        BSE_C_Teachers(String^ sectionName, String^ filePath)
        {
            InitializeComponent();
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->button1->Click += gcnew System::EventHandler(this, &BSE_C_Teachers::button1_Click);
            // 
            // BSE_C_Teachers
            // 
            ...
            this->Name = L"BSE_C_Teachers";
            this->Text = L"BSE_C_Teachers";
            this->Load += gcnew System::EventHandler(this, &BSE_C_Teachers::BSE_C_Teachers_Load);
            this->ResumeLayout(false);

        }

        void BSE_C_Teachers_Load(System::Object^ sender, System::EventArgs^ e)
        {
        ...
        void LoadTeachers()
        {
            String^ filePath = "BSE-C_teachers.txt"; // Path to the teachers file
            try
            {
        ...
        void button1_Click(System::Object^ sender, System::EventArgs^ e)
        {
            ...
            {
                String^ sectionName = "BSE-C"; // Assuming BSE-C section for demonstration
                String^ teacherFilePath = "BSE-C_timetable.txt";
