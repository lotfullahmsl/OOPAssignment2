...
namespace OOPAssignment2 {
    ...
    public ref class BSE_E_Teachers : public System::Windows::Forms::Form
    {
    public:

        BSE_E_Teachers(String^ sectionName, String^ filePath)
        {
            InitializeComponent();
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->button1->Click += gcnew System::EventHandler(this, &BSE_E_Teachers::button1_Click);
            // 
            // BSE_E_Teachers
            // 
            ...
            this->Name = L"BSE_E_Teachers";
            this->Text = L"BSE_E_Teachers";
            this->Load += gcnew System::EventHandler(this, &BSE_E_Teachers::BSE_E_Teachers_Load);
            this->ResumeLayout(false);

        }

        void BSE_E_Teachers_Load(System::Object^ sender, System::EventArgs^ e)
        {
        ...
        void LoadTeachers()
        {
            String^ filePath = "BSE-E_teachers.txt"; // Path to the teachers file
            try
            {
        ...
        void button1_Click(System::Object^ sender, System::EventArgs^ e)
        {
            ...
            {
                String^ sectionName = "BSE-E"; // Assuming BSE-E section for demonstration
                String^ teacherFilePath = "BSE-E_timetable.txt";
